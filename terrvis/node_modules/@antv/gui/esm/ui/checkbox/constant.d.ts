...
export declare const CHECKBOX_RECT_STYLE: {
    default: import("../../shapes/types").OmitConflictStyleProps<import("@antv/g-lite").RectStyleProps>;
    selected: import("../../shapes/types").OmitConflictStyleProps<import("@antv/g-lite").RectStyleProps>;
};
