...
function applyTitleStyle(title, group, axis, attr, animate) {
    ...
    var _a = __read(splitStyle(style), 2), titleStyle = _a[0], _b = _a[1], _c = _b.transform, transform = _c === void 0 ? '' : _c, groupStyle = __rest(_b, ["transform"]);
    ...
    // @ts-ignore
    select(axis._offscreen || axis.querySelector(CLASS_NAMES.mainGroup.class)), group, attr), x = _d.x, y = _d.y;
...
export function renderTitle(container, axis, attr, animate) {
    ...
    return container
        ...
        .data([{ title: titleText }], function (d, i) { return d.title; })
        .join(function (enter) {
        return enter
