...
import { add, defined, ellipsisIt, getCallbackValue, hide, inRange, percentTransform, radToDeg, renderExtDo, scale, select, show, splitStyle, subStyleProps, } from '../../../util';
...
function renderLabel(container, datum, data, style, attr) {
    ...
    applyTextStyle(label, __assign({ textAlign: getLabelAlign(datum.value, rotate, attr), textBaseline: 'middle' }, labelStyle));
