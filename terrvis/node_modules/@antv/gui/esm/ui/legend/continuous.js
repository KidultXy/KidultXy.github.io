...
var Continuous = /** @class */ (function (_super) {
    ...
    Continuous.prototype.renderHandles = function () {
        ...
        this.handlesGroup
            ...
            .join(function (enter) {
            return enter
                .append(function () { return new Handle({ style: style }); })
    ...
    Continuous.prototype.renderLabel = function (container) {
        ...
        var labelAndTickStyle = subStyleProps(this.attributes, 'label');
        var align = labelAndTickStyle.align;
        var tickStyle = subStyleProps(labelAndTickStyle, 'tick');
        var labelStyle = subStyleProps(labelAndTickStyle, 'tick', true);
