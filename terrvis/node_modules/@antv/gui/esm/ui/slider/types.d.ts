...
export type SliderStyleProps = GroupStyleProps & PrefixObject<RectStyleProps, 'track'> & PrefixObject<RectStyleProps, 'selection'> & HandleStyleProps & Partial<PrefixStyleProps<Omit<SparklineStyleProps, 'width' | 'height'>, 'sparkline'>> & {
