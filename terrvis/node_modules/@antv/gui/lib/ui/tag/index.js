...
var Tag = /** @class */ (function (_super) {
    ...
    Tag.prototype.render = function (attributes, container) {
        ...
        var group = (0, util_2.maybeAppend)(container, '.tag-content', 'g')
            ...
            .style('zIndex', 0)
            .node();
        var style = marker ? { marker: marker } : { symbol: 'triangle', size: 0 };
        // @ts-ignore
        var markerShape = (0, util_2.maybeAppend)(group, '.tag-marker', function () { return new marker_1.Marker({ style: style }); })
