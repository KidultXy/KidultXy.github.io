...
var Sparkline = /** @class */ (function (_super) {
            ...
            return {
                columns: data.map(function (column, i) {
                    return column.map(function (val, j) {
                        ...
                        return tslib_1.__assign(tslib_1.__assign({ fill: _this.getColor(i) }, columnStyle), (isStack
                            ? {
                                x: x.map(j),
                                y: y.map(val),
                                width: bandWidth,
    ...
    Sparkline.prototype.render = function (attributes, container) {
        this.container = (0, util_2.maybeAppend)(container, '.container', 'rect').attr('className', 'container').node();
        var type = attributes.type;
        var className = "spark".concat(type);
        var style = type === 'line' ? this.linesStyle : this.columnsStyle;
        this.spark = (0, util_2.maybeAppend)(container, ".".concat(className), function () {
            if (type === 'line')
