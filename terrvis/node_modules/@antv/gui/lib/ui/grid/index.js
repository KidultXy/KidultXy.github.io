...
function renderGridLine(container, data, attr, style) {
    ...
    var lines = data.map(function (item, idx) { return ({
    ...
    return container
        ...
        return enter.append('path').each(function (datum, index) {
            var lineStyle = (0, util_1.getCallbackValue)((0, util_1.getPrimitiveAttributes)(tslib_1.__assign({ path: datum.path }, style)), [
                datum,
                index,
                lines,
            ]);
            this.attr(tslib_1.__assign({ class: CLASS_NAMES.line.name, stroke: '#D9D9D9', lineWidth: 1, lineDash: [4, 4] }, lineStyle));
        });
    }, function (update) {
        return update.each(function (datum, index) {
            ...
            (0, animation_1.transition)(this, lineStyle, animate.update);
        });
    }, function (exit) {
