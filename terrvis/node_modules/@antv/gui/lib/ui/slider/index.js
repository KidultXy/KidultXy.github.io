...
var Slider = /** @class */ (function (_super) {
    ...
    function Slider(options) {
        ...
        _this.onDragging = function (e) {
            ...
            e.stopPropagation();
            var currPos = _this.getOrientVal((0, util_1.getEventPos)(e));
    ...
    Object.defineProperty(Slider.prototype, "sparklineStyle", {
        get: function () {
            ...
            if (orientation !== 'horizontal')
                return null;
            var attr = (0, util_1.subStyleProps)(this.attributes, 'sparkline');
    ...
    Object.defineProperty(Slider.prototype, "availableSpace", {
        get: function () {
            ...
            var _a = tslib_1.__read((0, util_1.parseSeriesAttr)(padding), 4), top = _a[0], right = _a[1], bottom = _a[2], left = _a[3];
    ...
    Slider.prototype.setValues = function (values, animate) {
        ...
        (0, animation_1.transition)(this.selectionShape.node(), this.selectionStyle, animation);
    ...
    Slider.prototype.updateHandlesPosition = function (animation) {
        if (!this.attributes.showHandle)
            return;
        (0, animation_1.transition)(this.startHandle, this.getHandleStyle('start'), animation);
        (0, animation_1.transition)(this.endHandle, this.getHandleStyle('end'), animation);
    };
    ...
    Slider.prototype.renderTrack = function (container) {
        ...
        var style = (0, util_1.subStyleProps)(this.attributes, 'track');
        this.trackShape = (0, util_1.select)(container)
            .maybeAppendByClassName(constant_1.CLASS_NAMES.track, 'rect')
            .styles(tslib_1.__assign(tslib_1.__assign({ cursor: brushable ? 'crosshair' : 'default' }, this.shape), style));
    };
    Slider.prototype.renderSparkline = function (container) {
        var _this = this;
        var orientation = this.attributes.orientation;
        var sparklineGroup = (0, util_1.select)(container).maybeAppendByClassName(constant_1.CLASS_NAMES.sparklineGroup, 'g');
        (0, util_1.ifShow)(orientation === 'horizontal', sparklineGroup, function (group) {
    ...
    Object.defineProperty(Slider.prototype, "selectionStyle", {
        get: function () {
            var style = (0, util_1.subStyleProps)(this.attributes, 'selection');
            return tslib_1.__assign(tslib_1.__assign({}, style), this.calcMask());
        },
        enumerable: false,
        configurable: true
    });
    Slider.prototype.renderHandles = function () {
        ...
        var that = this;
        (_a = this.foregroundGroup) === null || _a === void 0 ? void 0 : _a.selectAll(constant_1.CLASS_NAMES.handle.class).data(data, function (d) { return d.type; }).join(function (enter) {
            return enter
                .append(function (_a) {
                var type = _a.type;
    ...
    Slider.prototype.renderSelection = function (container) {
        this.foregroundGroup = (0, util_1.select)(container).maybeAppendByClassName(constant_1.CLASS_NAMES.foreground, 'g');
        this.selectionShape = this.foregroundGroup
            .maybeAppendByClassName(constant_1.CLASS_NAMES.selection, 'rect')
    ...
    Slider.prototype.clampValues = function (values, precision) {
        ...
        var _c = tslib_1.__read(this.getValues().map(function (num) { return (0, util_1.toPrecision)(num, precision); }), 2), prevStart = _c[0], prevEnd = _c[1];
        var _d = tslib_1.__read((values || [prevStart, prevEnd]).map(function (num) { return (0, util_1.toPrecision)(num, precision); }), 2), startVal = _d[0], endVal = _d[1];
        // 交换startVal endVal
        if (startVal > endVal) {
    ...
    Slider.prototype.calcHandleText = function (handleType) {
        var _a = this.attributes, orientation = _a.orientation, formatter = _a.formatter;
        var handleStyle = (0, util_1.subStyleProps)(this.attributes, 'handle');
        var labelStyle = (0, util_1.subStyleProps)(handleStyle, 'label');
        ...
        var temp = new shapes_1.Text({
            style: tslib_1.__assign(tslib_1.__assign({}, labelStyle), { text: text }),
        });
        // 文字包围盒的宽高
    ...
    Slider.prototype.getHandleLabelStyle = function (handleType) {
        ...
        if (!showLabel)
            return {};
        var style = (0, util_1.subStyleProps)(this.attributes, 'handleLabel');
        return tslib_1.__assign(tslib_1.__assign({}, style), this.calcHandleText(handleType));
    };
    Slider.prototype.getHandleIconStyle = function () {
        var shape = this.attributes.handleIconShape;
        var style = (0, util_1.subStyleProps)(this.attributes, 'handleIcon');
    ...
    Slider.prototype.getHandleStyle = function (handleType) {
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, (0, util_1.superStyleProps)(this.getHandleIconStyle(), 'icon')), (0, util_1.superStyleProps)(tslib_1.__assign(tslib_1.__assign({}, this.getHandleLabelStyle(handleType)), textStyle), 'label')), handlePosition), { orientation: orientation, showLabel: showLabel, type: handleType, zIndex: 3 });
    };
