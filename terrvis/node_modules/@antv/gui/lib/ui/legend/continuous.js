...
var Continuous = /** @class */ (function (_super) {
    ...
    Continuous.prototype.renderHandles = function () {
        ...
        this.handlesGroup
            ...
            .join(function (enter) {
            return enter
                .append(function () { return new handle_1.Handle({ style: style }); })
    ...
    Continuous.prototype.renderLabel = function (container) {
        ...
        var labelAndTickStyle = (0, util_2.subStyleProps)(this.attributes, 'label');
        var align = labelAndTickStyle.align;
        var tickStyle = (0, util_2.subStyleProps)(labelAndTickStyle, 'tick');
        var labelStyle = (0, util_2.subStyleProps)(labelAndTickStyle, 'tick', true);
    ...
    Object.defineProperty(Continuous.prototype, "labelAxisStyle", {
        get: function () {
            var _a = this.attributes, showTick = _a.showTick, labelDirection = _a.labelDirection, labelSpacing = _a.labelSpacing;
            var ribbonSize = this.ribbonShape.size;
            var labelPosition = this.labelPosition;
