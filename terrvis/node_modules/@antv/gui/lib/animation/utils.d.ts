...
export declare function animate(target: DisplayObject | GUI<any>, keyframes: Keyframe[], options: GenericAnimation): import("@antv/g-lite").IAnimation | null;
/**
 ...
 */
export declare function transition(target: DisplayObject | GUI<any>, state: Record<string, any> | (DisplayObject | GUI<any>), options: GenericAnimation): import("@antv/g-lite").IAnimation | null;
