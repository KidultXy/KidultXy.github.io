...
import { adaptor, domainOf, G2Layout, inferComponentLayout, inferComponentShape, scaleOf, titleContent, } from './utils';
...
export const LegendCategory = (options) => {
    ...
    return (context) => {
        ...
        const legendStyle = Object.assign({ orientation: ['right', 'left', 'center'].includes(position)
                ? 'vertical'
                : 'horizontal', width,
            height, gridCol: gridCol !== null && gridCol !== void 0 ? gridCol : finalGridCol, gridRow: gridRow !== null && gridRow !== void 0 ? gridRow : finalGridRow, rowPadding: 0, colPadding: 8, titleText: titleContent(title) }, inferCategoryStyle(options, context));
