...
const ArcAxisComponent = (options) => {
    ...
    return ({ scales: [scale], value, coordinate, theme }) => {
        ...
        return new AxisComponent({
            style: adaptor(deepMix({}, axisTheme, defaultStyle, Object.assign(Object.assign({ type: 'arc', data, titleText: titleContent(title), grid }, rest), important))),
        });
    };
};
...
const LinearAxisComponent = (options) => {
    ...
    return ({ scales: [scale], value, coordinate, theme }) => {
        ...
        const finalAxisStyle = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, internalAxisStyle), { type: 'linear', data: getData(scale, domain, tickCount, labelFormatter, tickFilter, tickMethod, position, coordinate), titleText: titleContent(title), labelOverlap: inferLabelOverlap(transform, internalAxisStyle), grid: inferGrid(internalAxisStyle.grid, coordinate, scale), gridLength, 
