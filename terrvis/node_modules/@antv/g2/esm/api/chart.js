...
let Chart = class Chart extends View {
    constructor(options) {
        const _a = options || {}, { container, canvas, key = G2_CHART_KEY } = _a, rest = __rest(_a, ["container", "canvas", "key"]);
        super(rest, 'view');
    ...
    options(options) {
        ...
        this._options = deepMix(this._options || optionsOf(this), omit(options, SPEC_EXTERNAL_KEYS));
        return this;
    }
    getContainer() {
