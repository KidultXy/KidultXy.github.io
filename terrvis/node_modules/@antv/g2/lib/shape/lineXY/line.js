...
function getArrowMarker(arrowSize, arrowStyle) {
    const arrowMarker = new g_1.Path({
...
const Line = (options) => {
    ...
    return (points, value, coordinate, theme) => {
        ...
        const _a = (0, utils_1.getShapeTheme)(theme, mark, shape, defaultShape), { defaultColor, lineWidth } = _a, shapeTheme = __rest(_a, ["defaultColor", "lineWidth"]);
        const { color = defaultColor, size = lineWidth } = value;
        const arrowMarker = arrow
            ? getArrowMarker(arrowSize, Object.assign({ fill: style.stroke || color, stroke: style.stroke || color }, (0, helper_1.subObject)(style, 'arrow')))
            : null;
