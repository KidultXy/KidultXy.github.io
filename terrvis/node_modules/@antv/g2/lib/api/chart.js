...
exports.Chart = exports.props = exports.optionsOf = exports.removeContainer = exports.G2_CHART_KEY = exports.SPEC_EXTERNAL_KEYS = void 0;
...
exports.SPEC_EXTERNAL_KEYS = ['container', 'renderer'];
...
function Canvas(container, width, height, renderer = new g_canvas_1.Renderer(), plugins = []) {
    // DragAndDropPlugin is for interaction.
    // It is OK to register more than one time, G will handle this.
    plugins.push(new g_plugin_dragndrop_1.Plugin());
...
let Chart = class Chart extends composition_1.View {
    constructor(options) {
        const _a = options || {}, { container, canvas, key = exports.G2_CHART_KEY } = _a, rest = __rest(_a, ["container", "canvas", "key"]);
        super(rest, 'view');
    ...
    render() {
        if (!this._context.canvas) {
            ...
            const { width: adjustedWidth, height: adjustedHeight } = (0, size_1.getChartSize)(this._container, autoFit, width, height);
        ...
        return new Promise((resolve, reject) => {
            try {
                (0, runtime_1.render)(this.options(), this._context, () => resolve(this), reject);
            }
            catch (e) {
                reject(e);
            }
    ...
    options(options) {
        ...
        this._options = (0, util_1.deepMix)(this._options || optionsOf(this), (0, util_1.omit)(options, exports.SPEC_EXTERNAL_KEYS));
        return this;
    }
    getContainer() {
