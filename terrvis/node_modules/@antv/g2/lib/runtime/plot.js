...
function updateTooltip(selection, options, view, library, context) {
    ...
    const tooltipOptions = inferInteraction(interaction).find((d) => d.type === 'tooltip');
...
function initializeState(markState, options, library) {
    ...
    const components = (0, component_1.inferComponent)(inferComponentScales(Array.from(scales), states, markState), options, library);
...
function plotView(view, selection, transitions, library) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const componentsTransitions = selection
            ...
            .append((options) => (0, component_1.renderComponent)((0, util_1.deepMix)({ animate: componentAnimateOptions }, options), coordinate, theme, library, markState)), (update) => update.transition(function (options) {
            const { preserve = false } = options;
            if (preserve)
                return;
            const newComponent = (0, component_1.renderComponent)((0, util_1.deepMix)({ animate: componentAnimateOptions }, options), coordinate, theme, library, markState);
