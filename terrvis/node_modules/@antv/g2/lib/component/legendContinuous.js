...
function inferContinuousConfig(scales, value, options, component) {
    ...
    const { orientation, width, height, length } = (0, utils_1.inferComponentShape)(value, options, component);
...
const LegendContinuous = (options) => {
    ...
    return ({ scales, value, theme }) => {
        ...
        layoutWrapper.appendChild(new gui_1.Continuous({
            style: (0, utils_1.adaptor)(Object.assign({}, legendTheme, Object.assign(Object.assign({ titleText: (0, utils_1.titleContent)(title), titleFontSize: 12, handle: false, indicator: false, labelAlign: 'value', labelFormatter: typeof labelFormatter === 'string'
                    ? (d) => (0, d3_format_1.format)(labelFormatter)(d.label)
                    : labelFormatter }, inferContinuousConfig(scales, value, options, exports.LegendContinuous)), style), rest)),
        }));
